...
const approvedOrderColor = Color(0xffFFFF00);
const emptyOrderColor = Color(0xff008000);
const transferredOrderColor = Color(0xffFFA500);

const greyTextColor = Color(0xff515254);
